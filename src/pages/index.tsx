...
export default function Home() {
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center">
      ...
      />
      <div className="bg-white w-3/4 lg:w-3/5 h-2/5 rounded-lg text-center align-middle">
      ...
      <div className="m-4 text-white text-4xl text-center">
        <p>
          <span className="uppercase font-bold">Notice:</span> Please note that
          if you are not present when your number is called,<br></br>
          the next number shall be accommodated. You will then be given a new
          number. <br></br>Thank you for your understanding.
        </p>
      </div>
